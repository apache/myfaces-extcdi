 ...
 * under the License.
 */
package org.apache.myfaces.extensions.cdi.core.alternative;
 ...
 */
@ApplicationScoped
public class AlternativeCoreConfigImplStartupObserver extends AbstractStartupObserver
{
    protected void logCoreConfiguration(@Observes StartupEvent startupEvent)
    {
        String moduleVersion = detectModuleVersion();

        StringBuilder info = new StringBuilder("[Started] MyFaces CODI (Extensions CDI) Alternative Core-Impl");
    ...
    {
        String version = ClassUtils.getJarVersion(AlternativeCoreConfigImplStartupObserver.class);
