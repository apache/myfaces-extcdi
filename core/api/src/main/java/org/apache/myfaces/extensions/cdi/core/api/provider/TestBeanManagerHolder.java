...
class TestBeanManagerHolder extends RootBeanManagerHolder
{
    ...
    TestBeanManagerHolder(BeanManager beanManager)
    {
        super(beanManager);
    }
    ...
    BeanManager getBeanManager()
    {
        ...
        //to keep the root-bean-manager support
        BeanManager jndiBeanManager = BeanManagerProvider.getInstance().resolveBeanManagerViaJndi();

        if (jndiBeanManager != null)
        {
            this.lazyBeanManager = jndiBeanManager;
        }
        return this.lazyBeanManager;
    }
}
